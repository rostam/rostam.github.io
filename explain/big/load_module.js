...
function eval_line(timestamp) {
    ...
    var selectedSpeed = sel.options[sel.selectedIndex].value;
    var speed = 100;
    if(selectedSpeed == "veryslow") speed = 550;
    if(selectedSpeed == "slow") speed = 250;
    if(selectedSpeed == "normal") speed = 100;
    if(selectedSpeed == "fast") speed = 50;
    if(progress > speed) {
