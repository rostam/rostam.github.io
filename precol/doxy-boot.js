$( document ).ready(function() {
    ...
    $('img[OtherSources="ftv2ns.png"]').replaceWith('<span class="label label-danger">N</span> ');
    $('img[OtherSources="ftv2cl.png"]').replaceWith('<span class="label label-danger">C</span> ');
